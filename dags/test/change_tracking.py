...
def sync_changes_to_snowflake(**context):
    ...
    table_name = 'Features'
    pk_column = 'Id'
    last_change_version = int(Variable.get('last_change_version', default_var=0))
...
with DAG(dag_id='test.sync_sqlserver_to_snowflake', tags=['test'], start_date=datetime(2024, 1, 1), schedule=None, catchup=False) as dag:
