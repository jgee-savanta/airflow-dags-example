...
def copy_sqlserver_to_snowflake(**context):
    ...
    source_table = 'BrandVueMetaBeta.dbo.Features'
...
with DAG(dag_id='beta.fullcopy_sqlserver_to_snowflake', tags=['beta'], start_date=datetime(2024, 1, 1), schedule=None, catchup=False) as dag:
